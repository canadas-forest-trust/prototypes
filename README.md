...
Hosted HTML prototypes / POCs for Canada's Forest Trust, served via GitHub Pages.

Each POC lives in its own folder and is reachable at:
`https://canadas-forest-trust.github.io/prototypes/<poc-name>/`
